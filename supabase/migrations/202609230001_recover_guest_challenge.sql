-- The private invitation link can recover a guest seat until it is registered.
create function public.recover_guest_challenge(p_token text,p_actor uuid) returns jsonb
