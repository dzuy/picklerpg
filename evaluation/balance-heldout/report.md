...
Policy: Current local auto-play; allCourt tendencies; no LLM; both opening servers tested by default. 800 games. Fixed simulation step: 0.1 s.

| Scenario | Completed / capped | A wins | Home wins | Mean margin | Pickles | Paired seeds |
|---|---:|---:|---:|---:|---:|---:|
| equal-70 | 800 / 0 | 50.0% | 49.5% | 4.94 | 16 | 100 |
