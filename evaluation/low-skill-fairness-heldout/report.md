...
Policy: Current local auto-play; allCourt tendencies; no LLM; opening servers as listed in manifest. 400 games. Fixed simulation step: 0.1 s.

| Scenario | Completed / capped | A wins | Home wins | Mean margin | Pickles | Paired seeds |
|---|---:|---:|---:|---:|---:|---:|
| equal-50 | 400 / 0 | 50.0% | 49.0% | 4.57 | 4 | 50 |
