...
Policy: Current local auto-play; allCourt tendencies; no LLM; opening servers as listed in manifest. 160 games. Fixed simulation step: 0.1 s.

| Scenario | Completed / capped | A wins | Home wins | Mean margin | Pickles | Paired seeds |
|---|---:|---:|---:|---:|---:|---:|
| overhead-90-vs-50 | 160 / 0 | 70.0% | 57.5% | 5.13 | 2 | 20 |
...
|---|---:|---:|---:|---:|
| overhead-90-vs-50 | 6284 | 4.9 | 11 | 29 |
