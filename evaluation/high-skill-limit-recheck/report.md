...
Policy: Current local auto-play; allCourt tendencies; no LLM; opening servers as listed in manifest. 4 games. Fixed simulation step: 0.1 s.

| Scenario | Completed / capped | A wins | Home wins | Mean margin | Pickles | Paired seeds |
|---|---:|---:|---:|---:|---:|---:|
| equal-90 | 4 / 0 | 50.0% | 0.0% | 2.00 | 0 | 1 |
