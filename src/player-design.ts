...
export const APPEARANCE_OPTIONS={presentation:['girl','boy'],expression:['happy','determined','angry','crying','serious','confident'],paddleShape:['rectangular','squarish','rounded','circular'],face:['oval','round','angular'],hairStyle:['ponytail','short','bun','side-part','bob','curls','spiky','mohawk','long','none'],hat:['none','cap','backwards','visor','headband','beanie','bucket'],glasses:['none','square','round','sunglasses','sport','oval','cat-eye','hexagon'],shoeStyle:['court','runner','high-top','slip-on'],top:['tank','jersey','polo','hoodie'],bottom:['shorts','skirt','skort','pleated-skirt','long-shorts'],accessory:['none','wristband','watch']} as const;
