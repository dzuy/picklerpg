...
export function appNavigation(active:NavigationPage,navigate?:(page:NavigationPage,href:string)=>void){
 ...
 const icons={home:'<path d="m3 10 9-7 9 7M5 9v12h5v-7h4v7h5V9"/>',games:'<g transform="rotate(35 12 12)"><rect x="7" y="2" width="10" height="13" rx="3"/><path d="M10.5 15v5.5a1.5 1.5 0 0 0 3 0V15"/></g>',friends:'<circle cx="9" cy="7" r="3"/><path d="M3 21v-3a6 6 0 0 1 12 0v3m1-17a3 3 0 0 1 0 6m3 11v-3a6 6 0 0 0-2-4"/>',roster:'<rect x="3" y="3" width="18" height="18" rx="3"/><circle cx="9" cy="9" r="2"/><path d="M5 17v-1a4 4 0 0 1 8 0v1m3-9h2m-2 4h2m-2 4h2"/>',profile:'<circle cx="12" cy="8" r="4"/><path d="M4 22v-2a8 8 0 0 1 16 0v2"/>'};
 const filledIcons:Record<NavigationPage,string>={
