...
export interface Invitation {id:string;creatorId:string;recipientId:string;creatorName:string;recipientName:string;team:TeamSelection;court:'forest';scoring:CreateRemoteMatch['scoring'];status:'pending'|'accepted';createdAt:string;matchId:string|null}
